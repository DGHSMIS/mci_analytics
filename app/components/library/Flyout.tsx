...
function Flyout({
  ...
  return (
    <div
      className={`altd-flyout space-y-12 ${
        controllingComponent.length > 0 ? "relative" : ""
      }`}
    >
            ...
            {items.length > 0 &&
              ...
              items.map((item, index) => {
                return (
                  <Menu.Item key={index}>
                    <div
                      className={`z-50 flex w-full flex-col px-16 py-4 font-medium text-slate-700 sm:text-sm lg:text-sm ${
